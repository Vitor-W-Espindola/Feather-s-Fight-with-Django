...
urlpatterns = [
    ...
    path('dashboard/edit/<int:publication_id>/', views.edit_publication_page, name='fight_preview'),
    path('dashboard/edit/<int:publication_id>/send', views.fight_edit, name='fight_preview'),
    ...
    path('dashboard/request_preview/<int:request_id>', views.request_preview, name='request_preview'),
